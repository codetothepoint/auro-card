...
<div class="exampleWrapper">
     <auro-background minheight="300px" background="var(--auro-color-brand-midnight-400)">
      <auro-banner gap="0">
        ...
        <div slot="right">
          <auro-background minheight="250px" minheightsm="422px" minheightmd="326px" background="url(https://sitecore-prod-cd-westus2.azurewebsites.net/-/media/Images/pages/oneworld-hub/MP-L.png) bottom center/cover"></auro-background>
        </div>
      </auro-banner>
  </auro-background>
</div>
